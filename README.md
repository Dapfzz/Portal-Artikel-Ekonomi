...
Kalau ada file gambar di assets/images/artikel/, tambahkan .gitignore dan exclude folder itu supaya gambar upload nggak ikut ke repo
Sebaiknya config.php juga di-exclude atau diganti dengan config.example.php supaya credential database nggak keekspos
